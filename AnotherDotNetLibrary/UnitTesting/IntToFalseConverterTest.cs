...
namespace UnitTesting
{
    ...
    /// <summary>
    ///This is a test class for IntToFalseConverterTest and is intended
    ///to contain all IntToFalseConverterTest Unit Tests
    ///</summary>
    [TestClass]
    public class IntToFalseConverterTest
    {
        /// <summary>
        ...
        /// <summary>
        ///A test for IntToFalseConverter Constructor
        ///</summary>
        [TestMethod]
        public void IntToFalseConverterConstructorTest()
        {
            var target = new IntToFalseConverter();
        ...
        {
            var target = new IntToFalseConverter(); // TODO: Initialize to an appropriate value
