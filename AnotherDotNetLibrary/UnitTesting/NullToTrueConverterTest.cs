...
namespace UnitTesting
{
    ...
    /// <summary>
    ///This is a test class for NullToTrueConverterTest and is intended
    ///to contain all NullToTrueConverterTest Unit Tests
    ///</summary>
    [TestClass]
    public class NullToTrueConverterTest
    {
        /// <summary>
        ...
        /// <summary>
        ///A test for NullToTrueConverter Constructor
        ///</summary>
        [TestMethod]
        public void NullToTrueConverterConstructorTest()
        {
            var target = new NullToTrueConverter();
        ...
        {
            var target = new NullToTrueConverter(); // TODO: Initialize to an appropriate value
