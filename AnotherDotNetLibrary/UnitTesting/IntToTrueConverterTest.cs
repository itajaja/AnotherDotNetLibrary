...
namespace UnitTesting
{
    ...
    /// <summary>
    ///This is a test class for IntToTrueConverterTest and is intended
    ///to contain all IntToTrueConverterTest Unit Tests
    ///</summary>
    [TestClass]
    public class IntToTrueConverterTest
    {
        /// <summary>
        ...
        /// <summary>
        ///A test for IntToTrueConverter Constructor
        ///</summary>
        [TestMethod]
        public void IntToTrueConverterConstructorTest()
        {
            var target = new IntToTrueConverter();
        ...
        {
            var target = new IntToTrueConverter(); // TODO: Initialize to an appropriate value
