...
namespace UnitTesting
{
    ...
    /// <summary>
    ///This is a test class for InvertBoolConverterTest and is intended
    ///to contain all InvertBoolConverterTest Unit Tests
    ///</summary>
    [TestClass]
    public class InvertBoolConverterTest
    {
        ...
        /// <summary>
        ///A test for InvertBoolConverter Constructor
        ///</summary>
        [TestMethod]
        public void InvertBoolConverterConstructorTest()
        {
            var target = new InvertBoolConverter();
        ...
        {
            var target = new InvertBoolConverter(); // TODO: Initialize to an appropriate value
